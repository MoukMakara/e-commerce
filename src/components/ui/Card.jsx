  ...
  return (
    <>
      ...
      <div className="pt-6">
        ...
        <Link
          to={`../shop?category=${categoryId}&card=${dataFill.key}`}
        ...
        <div className="mt-2 flex items-center gap-2">
          ...
          {[...Array(5)].map((_, index) => {
            if (index < Number(Math.floor(dataFill.rate))) {
                return (
                    <svg
        ...
        <div className="mt-4 flex items-center  justify-between gap-4">
          ...
          <button
            type="button"
            onClick={() => handleAddtoCard(dataFill.key,dataFill.category)}
